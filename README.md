...
Sistema de consola dirigido al departamento de Recursos Humanos para gestionar los pagos semanales de los empleados. Permite registrar, actualizar y generar reportes de nómina para cuatro tipos de empleado: asalariado, por horas, por comisión, y asalariado por comisión — cada uno con su propia fórmula de cálculo de pago.
...
Abrir NominaApp.sln en Visual Studio
